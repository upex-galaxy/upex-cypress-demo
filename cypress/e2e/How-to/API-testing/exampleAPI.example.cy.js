...
const listA = 'string-ejemplo'; // ID para obtener la Lista que queremos
const key = 'string-ejemplo'; // Nuestra autenticación
const token = 'string-ejemplo'; // la autorización
