describe('GX-40938 | TS: ✅ToolsQA | Elements | Broken Links Images', () => {
	...
	it('40945| TC1: Validar que el logotipo de Tool QA se muestre correctamente', () => {
		cy.get('img[src="/images/Toolsqa.jpg"]').eq(1).should('be.visible');
	});
	it('40945| TC2: Validar que aparezcas la imagen rota en el titulo “Broken image”', () => {
		cy.get('img[src="/images/Toolsqa_1.jpg"]').should('be.visible');
	});
	it('40945| TC3: Validar que al hacer click en el link “Valid link” funcione correctamente', () => {
