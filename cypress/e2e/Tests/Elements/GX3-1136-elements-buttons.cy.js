describe('ToolsQA | Elements | Buttons', () => {
	...
	it('GX3-1137 | TC1: Validar mostrar mensaje al hacer doble clic en el botón "Double Click Me"', () => {
		cy.get('#doubleClickBtn').dblclick();
		cy.get('#doubleClickMessage').should('be.visible');
		cy.get('#doubleClickMessage').should('have.text', 'You have done a double click');
	});
	it('GX3-1137 | TC2: Validar mostrar mensaje al hacer clic derecho en el botón "Right Click Me"', () => {
		cy.get('#rightClickBtn').rightclick();
		cy.get('#rightClickMessage').should('be.visible');
		cy.get('#rightClickMessage').should('have.text', 'You have done a right click');
	});
	it('GX3-1137 | TC3: Validar mostrar mensaje al hacer clic en el botón "Click Me"', () => {
	...
	it('GX3-1137 | TC4: Validar NO mostrar mensaje al hacer clic en el botón "Double Click Me"', () => {
		cy.get('#doubleClickBtn').click();
		cy.get('#doubleClickMessage').should('not.exist');
	});
	it('GX3-1137 | TC5: Validar NO mostrar mensaje al hacer clic en el botón "Right Click Me"', () => {
		cy.get('#rightClickBtn').click();
		cy.get('#rightClickMessage').should('not.exist');
	});
	it('GX3-1137 | TC6: Validar NO mostrar mensaje al hacer clic derecho en el botón "Click Me"', () => {
