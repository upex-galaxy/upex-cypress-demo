...
describe('',()=>{
	...
	it('GX3-3430| usuario completa el formulario correctamente',()=>{
	...
	it('GX3-3430|Validar click submit sin completar formulario',()=>{
		textBox.clickSubmit()
		textBox.get.uploadData().should('not.be.visible')
	})

	it('GX3-3430|Validar formulario con campo email sin @',()=>{
		textBox.inputName(data.fullName);
	...
	it('GX3-3430|validar campo email sin caracteres antes del arroba',()=>{
		textBox.inputName(data.fullName);
	...
	it('GX3-3430|validar campo email sin caracteres despues del arroba',()=>{
		textBox.inputName(data.fullName);
	...
	it('GX3-3430|validar campo email sin punto',()=>{
		textBox.inputName(data.fullName);
	...
	it('GX3-3430|Validar formulario con campo email con 1 caracter antes del punto',()=>{
		textBox.inputName(data.fullName);
