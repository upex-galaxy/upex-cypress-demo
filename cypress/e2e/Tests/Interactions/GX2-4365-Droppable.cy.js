...
describe('This is your test project title', () => {
	...
	it('4366 |  Validate on tab simple when “Drag me” area is dropped on the “Drop here” area the “Drop here” area changes the background color to blue.', () => {
		droppable.SeleccionarSimple();
	...
	it('4366 | Validate on the first “Outer Droppable” area, if “Drag me” area is dragged then “Outer Droppable” area changes the background color to Green and Inner droppable (not greedy) area changes the background color to light Green.', () => {
		droppable.SeleccionarPropogation();
		droppable.draggable().trigger('mousedown', { which: 1, force: true });
		droppable.notGreedyInnerDropBox().trigger('mousemove');
		droppable.notGreedyInnerDropBox().should('have.css', 'background-color', data.verdeclaro);
	...
	it('4366 | Validate on the second "Outer Droppable" área if “Drag me” area is dragged to “Inner droppable (greedy)” area then the “Inner droppable (greedy)” area changes the background color to Light Green and "Outer Droppable" area changes the background color to green', () => {
		droppable.SeleccionarPropogation();
		droppable.draggable().trigger('mousedown', { which: 1, force: true });
	...
	it('4366 | Validate on “Drop here” if “Will Revert” area is dragged then “Drop here” area changes the background color to Green.', () => {
		droppable.SeleccionarRevert();
	...
	it('4366 | Validate on “Drop here” if “Not Revert” area is dragged then “Drop here” area changes the background color to Green.', () => {
		droppable.SeleccionarRevert();
	...
	it('4366 | Validate if “Will Revert” area is dropped on the “Drop here” area then “Will Revert” area goes back to the initial position and “Drop here” area changes the background color to Blue and text “Dropped” is displayed.', () => {
		droppable.SeleccionarRevert();
	...
	it('4366 | Validate on “Drop here” if “Not Revert” area is dropped on the “Drop here” area then “Not Revert” area cant be removed from the “Drop here” area and “Drop here” area changes the background color to Blue and text “Dropped” is displayed', () => {
		droppable.SeleccionarRevert();
