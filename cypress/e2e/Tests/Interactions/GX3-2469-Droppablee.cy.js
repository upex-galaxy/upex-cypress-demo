...
describe('GX3-2469 | ToolsQA | Interactions | Droppable ',()=>{
	...
	it('2476 | TC01 Validate that "Droppable Box" changes name and color when paired with Dragable Box',()=>{
	...
	it('2476| TC02 validate move "Not Acceptable" and "Aceptable" boxes to "Drope here" box in tap "Accept"' ,()=>{
	...
	it('2476| TC03 move "Drag me" to "Outer droppable (not greedy)" in tab "Prevent Propogation"',()=>{
	...
	it('2476| TC04 move "Drag me" to "Inner droppable (not greedy)" in tab "Prevent Propogation"',()=>{
		droppablePage.clickOnProptab()
		droppablePage.get.dragMe().trigger('mousedown', {which:1},{force: true})
	...
	it('2476| TC05 move "Drag me" to "Outer droppable (greedy)" in tab "Prevent Propogation"',()=>{
		droppablePage.clickOnProptab()
		droppablePage.get.dragMe().trigger('mousedown', {which:1},{force: true})
	...
	it('2476| TC06 move "Drag me" to "Inner droppable (greedy)" in tab "Prevent Propogation"',()=>{
		droppablePage.clickOnProptab()
		droppablePage.get.dragMe().trigger('mousedown', {which:1},{force: true})
	...
	it('2476| TC07 move "will revert" box to "Drop Here" box on Revert tab',()=>{
	...
	it('2476| TC08 move "Not revert" box to "Drop Here" box on Revert tab',()=>{
		droppablePage.clickOnDragTab()
