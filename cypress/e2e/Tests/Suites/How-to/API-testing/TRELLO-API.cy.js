...
describe("Ejemplo para demostrar cómo probar una API", () =>
{
    ...
    it("TC3: REQUEST de Método PUT a la API de TRELLO para EDITAR UNA CARD", () =>
    {
        ...
        cy.api({
            ...
            body: { // Si la API necesita un BODY tipo JSON en el request, esta es la manera:
                cover: { // Se coloca el Query Parameter aquí empezando el JSON
                    color: "blue",
                    brightness: "dark",
                    size: "full"
                }
        ...
        .then(({body}) => // En este caso, en lugar de usar "response.body" siempre, aquí se declara {body} para usarlo más sencillo:
        {
