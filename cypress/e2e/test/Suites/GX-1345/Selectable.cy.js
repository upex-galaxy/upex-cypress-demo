...
describe("Tools QA | Interactions | Selectable", () => {
    ...
    it("TC 5: Validar seleccionar y quitar selección de los elementos de la grilla.", () => {
        ...
        cy.wait(1000)
        cy.get('#row1 > :nth-child(1)').click({ force: true })
        cy.wait(1000)
        cy.get('#row1 > :nth-child(2)').click({ force: true })
        cy.wait(1000)
        cy.get('#row1 > :nth-child(3)').click({ force: true })
        cy.wait(1000)
        cy.get('#row2 > :nth-child(1)').click({ force: true })
        cy.wait(1000)
        cy.get('#row2 > :nth-child(2)').click({ force: true })
        cy.wait(1000)
        cy.get('#row2 > :nth-child(3)').click({ force: true })
        cy.wait(1000)
        cy.get('#row3 > :nth-child(1)').click({ force: true })
        cy.wait(1000)
        cy.get('#row3 > :nth-child(2)').click({ force: true })
        cy.wait(1000)
        cy.get('#row3 > :nth-child(3)').click({ force: true })
        cy.wait(1000)
    })
