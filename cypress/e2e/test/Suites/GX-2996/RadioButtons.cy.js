describe("GX-2996 | ToolsQA | Elements | Radio Buttons",() => {
    ...
    it("2996 | TC:1 Validar poder seleccionar RB Yes | Validar que fue seleccionado |",()=>{
	...
	it("2996 | TC:2 Validar poder seleccionar RB Impressive | Validar que fue seleccionado |",()=>{
		cy.get("[type='radio']").eq(1).click({force:true})
			.should("be.checked")
		cy.get(".mt-3").should("have.text", "You have selected Impressive")
    })
	it("2996 | TC:1 Validar no poder seleccionar RB No | Validar que no fue seleccionado |",()=>{
