...
class Form {
	...
	contactData = {
		enterlN: this.get.lastName().type(randomLastName),
		enteruE: this.get.userEmail().type(randomEmail),
		enteruN: this.get.userNumber().type(randomMobile),
		enterfN: this.get.firstName().type(randomFirstName),
		enteruA: this.get.userAddress().type(randomAddress),
	};
